...
export class InspectorComponent implements OnInit {
    ...
    constructor(
        ...
        private inspectorDrawerService:InspectorDrawer
    ) {}
    ...
    ngOnInit() {
        ...
        this.inspector.InspectorToggle.subscribe(state =>{
            if(state == 'true'){
                this.codeInspector = false;
            }
    ...
    toggleInspector(){
        this.codeInspector = !this.codeInspector;
        this.inspector.inspectorToggle(this.codeInspector);
        
        //this.inspectorDrawerService.setInspectorToggle(this.codeInspector)
    }
