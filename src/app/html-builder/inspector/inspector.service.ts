...
export class Inspector {
    ...
    public InspectorToggle :Subject<string> = new Subject();

    public inspectorToggleHtml :Subject<string> = new Subject()
    ...
    inspectorToggle(value){
        this.inspectorToggleHtml.next(value)
    }

    public togglePanel(name: PanelNames) {
        this.activePanel = name;
        this.panelChanged.next(name);
        this.InspectorToggle.next('true');
    }
