...
export class HtmlBuilderComponent implements OnInit, OnDestroy {
    ...
    ngOnInit() {
        ...
        this.inspector.inspectorToggleHtml.subscribe(state =>{
            if(state.toString() == 'true'){
                this.inspector_content = true;
            }
            if(state.toString() == 'false'){
                this.inspector_content = false
            } 
        })

        this.inspector.panelChanged.subscribe(state =>{
            if(this.inspector_content == true){
                this.inspector_content = !this.inspector_content;
            }
